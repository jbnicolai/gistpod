...
var Helpers = module.exports = {
    ...
    readValueFromConfig: function (key, callback) {
        Helpers.readConfig(function (err, config) {
            if (err) { return callback(err) }
    ...
    writeGistPodspecEntriesToCache: function (entries, callback) {
        // for some reason, listing the domain using the 'githubusercontent.com' urls returned by the API causes CocoaPods to bail when you try to run `pod install`
        for (var i in entries) {
